...
import { EPacksTypes } from 'src/modules/packs/constants/packs-type.enum';
import {
  maxAgePlayer,
  maxRatingPlayer,
  maxSkillPlayer,
...
import { ERolePlayer } from 'src/modules/real-player/constants/rolePlayer.enum';
import { CreateRealPlayerReqDto } from 'src/modules/real-player/dto/create-real-player-req.dto';
import { GetRandomPlayerForPackDto } from 'src/modules/real-player/dto/get-random-player-for-pack.dto';
import { QueryGetRealPlayersReqDto } from 'src/modules/real-player/dto/query-get-real-players-req.dto';
import { isExistPlayers } from 'src/modules/real-player/helpers/is-exist-player.helper';
import { ratingHelper } from 'src/modules/real-player/helpers/rating.helper';
